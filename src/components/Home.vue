    ...
    <a-layout>
      <a-layout-sider style="background-color: white;color: white;height:100%">
        <div class="navbar">
          ...
          <div class="navbar-item" @click="openGroupA" :style="'height:' + showGroupA == true ? '500px' : '0'">
            <a-icon type="pic-center" class="navbar-icon" />折叠面板A
          ...
          <a-modal :visible="isChpvisible" :maskClosable="true" :confirm-loading="confirmLoading" @ok="updatePass"
            @cancel="onCancel" cancelText="再想想" okText="修改" okType="danger">
